    ...
    >
      ...
      <VStack m={"2"} mr={0} gap={1} align="stretch">
        ...
        >
          ...
          >
            <CategoryNavItem
              urlPath={"practical/information-technology"}
              load={load}
              type={"subject"}
              itemName={"IT Skills"}
            >
          ...
          >
            <CategoryNavItem
              urlPath={"practical/statistics-and-analytics"}
              load={load}
              type={"subject"}
              itemName={"Statistics And Analytics"}
            >
              {items
                .filter((item) => {
          ...
          >
            <CategoryNavItem
              urlPath={"practical/python-programming"}
              load={load}
              type={"subject"}
          ...
          >
            <CategoryNavItem
              urlPath={"practical/data-structures-and-algorithms-with-python"}
              load={load}
              type={"subject"}
              itemName={"DSA with Python"}
            >
              {items
                .filter((item) => {
                ...
                .experiments.map((experiment) => {
                  return (
                    <CategoryNavItem
                      urlPath={
                        "practical/data-structures-and-algorithms-with-python"
                      }
                      type={"subject"}
                      load={load}
                      itemName={experiment.title}
